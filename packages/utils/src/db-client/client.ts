...
function createPostgresClient(connectionString: string, options: DbClientOptions = {}) {
...
async function resolveConnectionString(explicit?: string): Promise<string> {
...
export async function initDb(options: DbClientOptions = {}): Promise<DbClient> {
...
export function getDb(options: DbClientOptions = {}): DbClient {
  if (dbInstance) return dbInstance;
