...
/** Department entity — matches schema/departments.ts departments */
...
/** Fellowship member entity — matches schema/fellowships.ts fellowshipMembers */
...
/** Fellowship meeting entity — matches schema/fellowships.ts fellowshipMeetings */
