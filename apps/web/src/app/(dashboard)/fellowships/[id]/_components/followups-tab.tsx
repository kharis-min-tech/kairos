      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="space-y-1">
              <Label htmlFor="fellowship-fu-contacted">Contacted on *</Label>
              <DateSelect
                id="fellowship-fu-contacted"
                value={contactedAt}
          ...
          {type === 'contact' ? (
            ...
            <>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-1">
                  <Label htmlFor="fellowship-fu-arrival">Arrival time *</Label>
                  <TimeSelect
                    value={arrivalTime}
                ...
                <div className="space-y-1">
                  <Label htmlFor="fellowship-fu-departure">
          ...
          <div className="space-y-1">
            <Label htmlFor="fellowship-fu-next">Next follow-up (optional)</Label>
            <DateSelect
