...
import type { DormantAttendee } from '@kairos/types';
...
beforeEach(() => {
  ...
  role = 'leader';
  attendees = rows;
  capabilities = { visibleFormTypes: ['altar_call'], canSeeAttendees: true };
  archiveMutate.mockResolvedValue({ archived: 1 });
});

describe('AttendeesPage', () => {
  it('blocks a caller without canSeeAttendees', () => {
    capabilities = { visibleFormTypes: [], canSeeAttendees: false };
    render(<AttendeesPage />, { wrapper });
