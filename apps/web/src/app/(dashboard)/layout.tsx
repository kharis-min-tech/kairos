...
type NavItem = {
  ...
  /**
   * Any-of capability gate. If provided, the item is visible when the caller
   * holds at least one of the listed capabilities. Used for surfaces (e.g.
   * /concerns) that mirror the API's OR-of-capabilities access rule.
   */
