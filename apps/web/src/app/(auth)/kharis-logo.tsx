...
export function KharisLogoIcon({ size = 40 }: { size?: number }) {
  return (
    <div
      className="flex items-center justify-center rounded-xl bg-gradient-to-br from-[#5D3FD3] to-[#7C5CE7]"
  ...
  return (
    <div className="px-1 text-center">
      <div className="mb-4 flex items-center justify-center gap-2">
        <img src="/logo.png" alt="" width={22} height={22} className="opacity-80 invert dark:invert-0" />
