...
const memberAuth = { memberId: '000-member', email: 'm@x', systemRole: 'member' as const, branchId };
const otherBranchAuth = { memberId: '000-o', email: 'o@x', systemRole: 'leader' as const, branchId: 'other-branch' };
