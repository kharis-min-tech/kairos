...
Go to **Reports** and click the **Growth** tab in the top-right.
...
The Dashboard's Mission Control panel includes a **Membership Growth** chart showing the last 6 months of member count. Each point represents the total active member count at the end of that month.

Use the Reports page Growth tab for a more detailed view with date range controls.
